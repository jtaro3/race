...
const visualDesign={
  ...
  wall:{sampleStep:5,worldSize:42,base:'#4a4339',face:'#e8d6a7',top:'#fff2c9',accent:'#dc574b'},
  ...
  sprites:{
    ...
    wall:{legend:{O:'#423c37',C:'#f8efd2',R:'#df5447'},pixels:['CCCCCC','CRRCRC','CRRCRC','OOOOOO']}
  }
};
